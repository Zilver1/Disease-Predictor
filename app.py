...
def DT():
    ...
    return render_template("index.html", prediction_text0 = "The disease is {}".format(pre1))
...
def RF():
    ...
    session.pop("inputest", None)
    return render_template("index.html", prediction_text1 = "The disease is {}".format(pre1))
...
def KNN():
    ...
    session.pop("inputest", None)
    return render_template("index.html", prediction_text2 = "The disease is {}".format(pre1))
...
def NB():
    ...
    session.pop("inputest", None)
    return render_template("index.html", prediction_text3 = "The disease is {}".format(pre1))
...
def SVM():
    ...
    session.pop("inputest", None)
    return render_template("index.html", prediction_text4 = "The disease is {}".format(pre1))
